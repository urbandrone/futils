...
function buildMemberNav(items, itemHeading, itemsSeen, linktoFn) {
  ...
  if (items && items.length) {
    ...
    nav.push(buildNavSection(itemHeading))
...
/**
 * Helper to generate navigation list section headers around navigation header content
 * for headings and filenames.
 * 
 * @param {String} content navigation header content
 * @return {String}
 */
function buildNavSection (content) {
  return [
    '<li class="nav-heading nav-heading--section">',
    content,
    '</li>'
  ].join('')
}
